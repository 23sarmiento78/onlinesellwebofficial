...
class ForoManager {
  ...
  loadPosts() {
    const savedPosts = localStorage.getItem('foro_posts');
    if (savedPosts) {
    ...
    return [
      {
        ...
        content: "¡Nuevo proyecto lanzado! 🚀 Hemos desarrollado un sitio web moderno para un restaurante local en Villa Carlos Paz. Tecnologías utilizadas: React, Node.js y diseño responsivo. ¿Qué opinan?",
        ...
        tags: ["React", "Node.js", "Villa Carlos Paz", "Desarrollo Web"],
        likedBy: [],
      ...
      },
      {
        ...
        content: "Consejo del día: ¿Sabías que el 70% de los usuarios abandonan un sitio web si tarda más de 3 segundos en cargar? La optimización de velocidad es clave para el SEO y la experiencia del usuario. #SEO #DesarrolloWeb #VillaCarlosPaz",
        timestamp: new Date(Date.now() - 5 * 60 * 60 * 1000).toISOString(),
        likes: 18,
        comments: 12,
        shares: 5,
        category: "SEO",
        tags: ["SEO", "Desarrollo Web", "Villa Carlos Paz", "Optimización"],
        likedBy: [],
        isAutoGenerated: false
      }
    ];
  ...
  createPost(content, image = null, category = 'General', tags = []) {
    const newPost = {
      id: Date.now(),
