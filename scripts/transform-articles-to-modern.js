// Script para transformar artículos HTML antiguos a la plantilla moderna
// Lee todos los HTML de /public/blog/, extrae el contenido y lo reestructura usando modern-article-template.html
// Uso: node scripts/transform-articles-to-modern.js
...
function extractContent(html) {
  // Busca el primer <article>...</article> o <main>...</main> o <body>...</body>
...
function extractImage(html) {
  // Busca la primera imagen destacada
...
function transformArticle(oldHtml, template) {
  ...
  // Puedes agregar más reemplazos según lo necesites
  return modern;
}
