...
// Plasmic Project: itEW3TMfVm3rf4KPtJBbHb
// Component: 2JsT7BgVWPVG
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__zEt68)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
          ...
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__fHmSl)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__mr3Mh)}
                  role={"img"}
                />
              </div>
            )}
          ...
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__knBrk)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__syQc)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
